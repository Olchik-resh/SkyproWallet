...
.months-scroll-wrapper {
  ...
  scrollbar-color: rgba(120, 120, 120, 0.8) rgba(217, 217, 217, 1);
}
.months-scroll-wrapper::-webkit-scrollbar-thumb {
  background: rgba(120, 120, 120, 0.8); /* контрастный цвет ползунка */
  border-radius: 30px;
  border: 3px solid rgba(217, 217, 217, 1); /* создаёт "внутренний отступ" */
}
