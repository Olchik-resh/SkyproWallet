      ...
      <table>
        <tbody>
          <tr v-for="item in expenses" :key="item.id">
            <td class="tbl-description">{{ item.description }}</td>
            <td class="tbl-category">{{ item.category }}</td>
            <td class="tbl-date">{{ formatDate(item.date) }}</td>
            <td class="tbl-amount">{{ item.amount }}</td>
            <td class="action-col">
