...
const categories = [
  ...
  { key: 'transport', title: 'Транспорт', color: '#' },
  { key: 'home', title: 'Жилье', color: '#6EE4FE' },
  { key: 'entertainment', title: 'Развлечения', color: 'rgba(176, 174, 255, 1);' },
  { key: 'education', title: 'Образование', color: 'rgba(188, 236, 48, 1);' },
  { key: 'other', title: 'Другое', color: 'rgba(255, 185, 184, 1);' },
]
