...
const expenses = ref([
  { id: 1, description: 'Описание', category: 'Еда', date: '', amount: 250 },
  { id: 2, description: 'Описание', category: 'Транспорт', date: '', amount: 60 },
  { id: 3, description: 'Описание', category: 'Другое', date: '', amount: 500 },
])
