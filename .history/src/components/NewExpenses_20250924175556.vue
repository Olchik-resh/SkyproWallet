...
const categories = [
  {
    name: 'Еда',
    icon: `<svg width="16" height="16" fill="none"><path d="M8 1C9 3 13 7 8 15C3 7 7 3 8 1Z" stroke="#7334EA" stroke-width="1.2" fill="none"/></svg>`
  },
  {
    name: 'Транспорт',
    icon: `<svg width="16" height="16" fill="none"><rect x="2" y="7" width="12" height="7" rx="2" stroke="#7334EA" stroke-width="1.2" fill="none"/><circle cx="5" cy="14" r="1" fill="#7334EA"/><circle cx="11" cy="14" r="1" fill="#7334EA"/></svg>`
  },
  {
    name: 'Жилье',
