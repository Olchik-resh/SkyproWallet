...
.calendar-day.selected {
  border: 2px solid #7334ea; /* темно-фиолетовая рамка */
  background: #f1ebfd !important; /* светло-фиолетовый фон (опционально) */
  color: #7334ea !important; /* темно-фиолетовый текст (опционально) */
}
</style>
